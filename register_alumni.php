...
<body>
    ...
    <div class="content" style="margin-top: 20px; margin-left: -40px;">
    	<h1 class="form-row justify-content-center" style="margin-left: 60px;">Alumni SignUp</h1> <br>
    	...
    	<form action="register_alumni.inc.php" autocomplete="off" method="POST">
		      ...
		      <div class="center one">
		        <div class="form-row">
		        	<div class="form-group col-md-5">
			          <label for="cid">USN</label>
			          <input type="text" class="form-control" id="cid" name="cid" name="StudentUSN"  required>
			        </div>
			        <div class="form-group col-md-5">
